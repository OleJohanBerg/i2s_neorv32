...
## Pmod Header JD
set_property -dict {PACKAGE_PIN D4 IOSTANDARD LVCMOS33} [get_ports jtag_tdo_o]
#set_property -dict { PACKAGE_PIN D3    IOSTANDARD LVCMOS33 } [get_ports { jd[1] }]; #IO_L12N_T1_MRCC_35 Sch=jd[2]
set_property -dict {PACKAGE_PIN F4 IOSTANDARD LVCMOS33} [get_ports jtag_tck_i]
#set_property -dict { PACKAGE_PIN F3    IOSTANDARD LVCMOS33 } [get_ports { jd[3] }]; #IO_L13N_T2_MRCC_35 Sch=jd[4]
set_property -dict {PACKAGE_PIN E2 IOSTANDARD LVCMOS33} [get_ports jtag_tdi_i]
set_property -dict {PACKAGE_PIN D2 IOSTANDARD LVCMOS33} [get_ports jtag_tms_i]
#set_property -dict { PACKAGE_PIN H2    IOSTANDARD LVCMOS33 } [get_ports { jd[6] }]; #IO_L15P_T2_DQS_35 Sch=jd[9]
#set_property -dict { PACKAGE_PIN G2    IOSTANDARD LVCMOS33 } [get_ports { jd[7] }]; #IO_L15N_T2_DQS_35 Sch=jd[10]
...
set_input_delay -clock [get_clocks clk_in1] -min -add_delay 0.000 [get_ports {btn[*]}]
set_input_delay -clock [get_clocks clk_in1] -max -add_delay 0.100 [get_ports {btn[*]}]
set_input_delay -clock [get_clocks clk_in1] -min -add_delay 0.000 [get_ports {sw[*]}]
set_input_delay -clock [get_clocks clk_in1] -max -add_delay 0.100 [get_ports {sw[*]}]
set_input_delay -clock [get_clocks clk_in1] -min -add_delay 0.000 [get_ports jtag_tck_i]
set_input_delay -clock [get_clocks clk_in1] -max -add_delay 0.100 [get_ports jtag_tck_i]
set_input_delay -clock [get_clocks clk_in1] -min -add_delay 0.000 [get_ports jtag_tdi_i]
set_input_delay -clock [get_clocks clk_in1] -max -add_delay 0.100 [get_ports jtag_tdi_i]
set_input_delay -clock [get_clocks clk_in1] -min -add_delay 0.000 [get_ports jtag_tms_i]
set_input_delay -clock [get_clocks clk_in1] -max -add_delay 0.100 [get_ports jtag_tms_i]
set_input_delay -clock [get_clocks clk_in1] -min -add_delay 0.000 [get_ports uart_txd_in]
set_input_delay -clock [get_clocks clk_in1] -max -add_delay 0.100 [get_ports uart_txd_in]
set_output_delay -clock [get_clocks clk_in1] -min -add_delay 0.000 [get_ports {led[*]}]
set_output_delay -clock [get_clocks clk_in1] -max -add_delay 0.100 [get_ports {led[*]}]
set_output_delay -clock [get_clocks clk_in1] -min -add_delay 0.000 [get_ports jtag_tdo_o]
set_output_delay -clock [get_clocks clk_in1] -max -add_delay 0.100 [get_ports jtag_tdo_o]
set_output_delay -clock [get_clocks clk_in1] -min -add_delay 0.000 [get_ports uart_rxd_out]
set_output_delay -clock [get_clocks clk_in1] -max -add_delay 0.100 [get_ports uart_rxd_out]
